...
from continual_learning.continual_trainers import FixedDataContinualTrainer
...
def main(
    ...
    search_space = get_search_space(family=search_space_family, fixed=True)
    ...
    trainer = FixedDataContinualTrainer(
